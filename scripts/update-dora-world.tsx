...
interface UpdateDoraWorldResult {
...
async function main(): Promise<UpdateDoraWorldResult> {
    ...
    try {
      ...
      if (updateResult.success) {
        ...
        if (createResult.success) {
          ...
          console.error(
            `  ⚠️  Failed to update/create in Directus for content ${content.id}:`,
            createResult.error,
          );
        }
      }
...
export { main };
export type { UpdateDoraWorldResult };
